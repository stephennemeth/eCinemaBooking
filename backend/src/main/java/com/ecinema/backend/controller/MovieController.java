...
public class MovieController {
    ...
    public ResponseEntity<Movie> updateMovie(@PathVariable Long id, @RequestBody Movie movie) throws IllegalArgumentException {
        
        Movie savedMovie = this.movieService.updateMovie(id, movie);
